    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movies_ratings", x => x.user_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Netflix = table.Column<int>(type: "INTEGER", nullable: false),
                    AmazonPrime = table.Column<int>(name: "Amazon Prime", type: "INTEGER", nullable: false),
                    Disney = table.Column<int>(name: "Disney+", type: "INTEGER", nullable: false),
                    Paramount = table.Column<int>(name: "Paramount+", type: "INTEGER", nullable: false),
                    Max = table.Column<int>(type: "INTEGER", nullable: false),
                    Hulu = table.Column<int>(type: "INTEGER", nullable: false),
                    AppleTV = table.Column<int>(name: "Apple TV+", type: "INTEGER", nullable: false),
                    Peacock = table.Column<int>(type: "INTEGER", nullable: false),
